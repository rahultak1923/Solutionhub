...
const dynamicText = document.querySelector(".coding span");
const words = ["Custom Web Solutions", "E-commerce Solutions", "Progressive web apps", "Web Designing","Backend Architecture","Website Development"];
